        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedByEmail = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ProjectsId = table.Column<int>(type: "int", nullable: false),
                    SupervisorsEmail = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectSupervisor", x => new { x.ProjectsId, x.SupervisorsEmail });
                    table.ForeignKey(
                        name: "FK_ProjectSupervisor_Projects_ProjectsId",
                        column: x => x.ProjectsId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Projects_CreatedByEmail",
                table: "Projects",
                column: "CreatedByEmail");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectSupervisor_SupervisorsEmail",
