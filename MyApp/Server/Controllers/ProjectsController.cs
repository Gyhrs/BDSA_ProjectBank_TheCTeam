...
public class ProjectsController : ControllerBase // Inherits from ControllerBase. Controllerbase does not have view support (from MVC). If we want view support we can inherit from Controller. Controllerbase has http codes Ok = 200, etc.
{
    ...
    [AllowAnonymous]
    [ProducesResponseType(StatusCodes.Status404NotFound)] // This attribute produces more descriptive response details for web API help pages generated by tools like Swagger.
    ...
    public async Task<ActionResult<IReadOnlyCollection<ProjectDTO>>> Get()
    {
